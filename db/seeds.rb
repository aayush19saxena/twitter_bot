...
Response.create(message: "Meditation can help with #insomnia! http://nyti.ms/1LCs8hF Here's an app I love: calm.com")
...
Response.create(message: "Test SRK #badebadesheher!")
Response.create(message: "Test Gaandu #kritkatvij!")
